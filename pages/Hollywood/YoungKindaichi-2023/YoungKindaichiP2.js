...
const scrollSearch = myKey => {
  ...
  return (
    <div>
     <Head>
     <title>Watch Young Kindaichi PART 2 (2023) | HBO max Movies™</title>
<meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="keywords" content="HBO max Movies,streaming,latest movies,online tv,latest free movies,watch latest movies online,index of Young Kindaichi PART 2,Young Kindaichi PART 2 (2023) movie,watch Young Kindaichi PART 2 (2023) movie online,Young Kindaichi PART 2 (2023) movie download,Young Kindaichi PART 2 (2023) movie trailer" />

<meta property="og:locale" content="en_US" />
<meta property="og:site_name" content="HBO max Movies™ | Watch Movies and TV-Series Online Free" />
<meta property="og:type" content="movie" />
<meta property="og:title" content="Watch Young Kindaichi PART 2 (2023) | HBO max Movies™" />
<meta property="og:url" content="https://hbomaxmovies.netlify.app/YoungKindaichi-2023/" />
<meta property="og:image" content="https://hbomaxmovies.netlify.app/the-files-of-young-kindaichi-2023.webp" />
<meta property="og:image:secure_url" content="https://hbomaxmovies.netlify.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch Young Kindaichi PART 2 (2023) | HBO max Movies™" />
<meta name="twitter:image" content="https://hbomaxmovies.netlify.app/the-files-of-young-kindaichi-2023.webp" />
<meta name="description" content="Watch Young Kindaichi PART 2 Full Movie Online on HBO max Movies™, You can also download Young Kindaichi PART 2 (2023) in full HD quality to watch later offline." />
<script async="async" data-cfasync="false" src="//ophoacit.com/1?z=5720177"></script>
  ...
  <script src="https://cdn.jsdelivr.net/npm/tw-elements/dist/js/index.min.js"></script>
      ...
      <div class="bg-[#1a202c]">
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Young Kindaichi PART 2 (2023)   </h1>

     
    <iframe className="w-full aspect-w-16 aspect-h-9" src="https://sbhight.com/e/2487qiha8ek4.html" height={550}></iframe>
  ...
  <Link href="../../Hollywood/YoungKindaichi-2023/YoungKindaichiP1">
    ...
    <Link href="../../Hollywood/YoungKindaichi-2023/YoungKindaichiP2">
    ...
    <Link href="../../Hollywood/YoungKindaichi-2023/YoungKindaichiP3">
...
<h2 className=" text-medium font-sm text-center dark:text-white text-white"><strong>Genre:</strong> Thiller, Drama, Mystery.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Release year:</strong> 2023</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong> Shunpei Maruya, Hisashi Kimura.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> Korean</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Shunsuke Michieda, Moka Kamishiraishi, Taisho Iwasaki, Ikki Sawamura, Yuuki Luna, Maika Yamamoto, Reika Kirishima, Yuta Furukawa, Kimiko Yo, Masami Kosaka, Dai Watanabe, Katsuya.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> Follow Kindaichi Hajime, a high school student and a private detective with an IQ of 180 solves murder cases that are riddled with difficult clues with his friend, Nanase Miyuki and Kenmochi Isamu.</h2>
 ...
 <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Young Kindaichi PART 1 (2023) </h3>
 <Link href="../../Hollywood/YoungKindaichi-2023/DownloadFYKP1A">
...
<h3 className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Young Kindaichi PART 1 (2023)</h3>
<Link href="../../Hollywood/YoungKindaichi-2023/DownloadFYKP1B">
<button className="relative inline-flex items-center rounded-3xl  justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-white scale-100 hover:scale-110 ease-in duration-500 cursor-pointer">  
<span className="relative px-5 py-2.5  transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 ">
Download 
</span>
...
<h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Young Kindaichi PART 2 (2023) </h3>
<Link href="../../Hollywood/YoungKindaichi-2023/DownloadFYKP2A">
 <button className="relative inline-flex items-center rounded-3xl justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-white scale-100 hover:scale-110 ease-in duration-500 cursor-pointer">  
 <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0  ">
 Download 
 </span>
...
<h3 className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Young Kindaichi PART 2 (2023)</h3>
<Link href="../../Hollywood/YoungKindaichi-2023/DownloadFYKP2B">
<button className="relative inline-flex items-center rounded-3xl  justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-white scale-100 hover:scale-110 ease-in duration-500 cursor-pointer">  
<span className="relative px-5 py-2.5  transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 ">
Download 
</span>
...
<h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Young Kindaichi PART 3 (2023) </h3>
<Link href="../../Hollywood/YoungKindaichi-2023/DownloadFYKP3A">
 <button className="relative inline-flex items-center rounded-3xl justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-white scale-100 hover:scale-110 ease-in duration-500 cursor-pointer">  
 <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0  ">
 Download 
 </span>
