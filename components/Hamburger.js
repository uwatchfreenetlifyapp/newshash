...
export default function Home() {
  ...
  return (
	...
	<meta name="keywords" content="hbomaxmovies,streaming,latest movies,online tv,latest free movies,watch latest movies online,latest full movies online" />
	...
	<meta name="twitter:image" content="https://hbomaxmovies.netlify.app/og_image.jpg" />
      ...
      <nav className="w-full bg-gray-800 shadow">
        <div className="justify-between px-4  mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
          ...
          <Image src='/logo.png' alt='Logo' width={350} height={60} className="rounded-3xl "/>
              <a href="/">
